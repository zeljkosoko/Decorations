...
export class DecorationListComponent implements OnInit {
  ...
  @Output() forwardSelectedDecoration = new EventEmitter<Decoration>(); //emitter will has selected decoration-item object
  ...
  onSelectedDecoration(oneSelected: Decoration) {
    this.forwardSelectedDecoration.emit(oneSelected); //emitter emits decoration object to decorations.component
  }
}
